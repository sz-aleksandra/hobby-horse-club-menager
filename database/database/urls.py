...
urlpatterns = [
    ...
    path('addresses/get_in_city/', AddressesView.get_all_addresses_in_city, name='addresses_get_in_city'),
    path('addresses/get_in_street/', AddressesView.get_all_addresses_in_street, name='addresses_get_in_street'),
    path('addresses/add/', AddressesView.add_addresses, name='addresses_add'),
    path('addresses/update/', AddressesView.update_addresses, name='addresses_update'),
    path('addresses/delete/', AddressesView.delete_addresses, name='addresses_delete'),
    ...
    path('licences/get_by_id/', LicencesView.get_licence_by_id, name='licences_get_by_id'),
    ...
    path('groups/get_by_id/', GroupsView.get_group_by_id, name='groups_get_by_id'),
    ...
    path('accessory_types/get_by_id/', AccessoryTypesView.get_accessory_types_by_id, name='accessory_types_get_by_id'),
    ...
    path('horses/get_by_id/', HorsesView.get_horses_by_id, name='get_horses_by_id'),
